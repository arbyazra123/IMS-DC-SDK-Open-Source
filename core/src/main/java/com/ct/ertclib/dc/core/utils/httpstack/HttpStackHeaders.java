...
public final class HttpStackHeaders {
    private final String[] namesAndValues;

    HttpStackHeaders(Builder builder) {
        this.namesAndValues = (String[]) builder.namesAndValues.toArray(new String[builder.namesAndValues.size()]);
    }

    private HttpStackHeaders(String[] strArr) {
    ...
    public boolean equals(@Nullable Object obj) {
        return (obj instanceof HttpStackHeaders) && Arrays.equals(((HttpStackHeaders) obj).namesAndValues, this.namesAndValues);
    }
    ...
    public static HttpStackHeaders of(String... strArr) {
        if (strArr == null) {
            ...
            return new HttpStackHeaders(strArr2);
        } else {
            throw new IllegalArgumentException("Expected alternating header names and values");
        }
    }

    public static HttpStackHeaders of(Map<String, String> map) {
        if (map != null) {
            ...
            return new HttpStackHeaders(strArr);
        }
    ...
    public static final class Builder {
        ...
        public Builder add(String str, String str2) {
            HttpStackHeaders.checkName(str);
            HttpStackHeaders.checkValue(str2, str);
        ...
        public Builder addAll(HttpStackHeaders headers) {
        ...
        public HttpStackHeaders build() {
            return new HttpStackHeaders(this);
        }
    }
}
