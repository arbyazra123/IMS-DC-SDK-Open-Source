...
import com.ct.ctec.utils.JsonUtil
...
object JsonUtil {
    ...
    fun <T> fromJson(json: String, classOfT: Class<T>): T? {
        kotlin.runCatching {
            ...
            logger.error("fromJson failed, exception: $this")
        }
        return null
    }
    ...
    fun toJson(obj: Any): String {
        kotlin.runCatching {
            ...
            logger.error("toJson failed: $this")
        }
        return ""
    }
    ...
    fun removeJsonFieldWithGson(jsonString: String, fieldName: String): String {
    ...
    fun <T> convertVariableStringToClass(json: String, variableName: String, classOfT: Class<T>) : T? {
        val jsonObject = JSONObject(json)
        val dataStr = jsonObject.getString(variableName)
        return dataStr.let { JsonUtil.fromJson(it, classOfT) }
    }
}