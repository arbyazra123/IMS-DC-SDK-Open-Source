...
object DefaultMiniAppSeeder {
    ...
    private const val CURRENT_SEED_CONTENT_VERSION = 4
    ...
    private val DEFAULT_APPS = listOf(
        ...
        DefaultApp(appId = "602", appName = "Live Translate", assetFileName = "translation_miniapp.zip", eTag = "1.0.3", supportScene = 3)
    )
