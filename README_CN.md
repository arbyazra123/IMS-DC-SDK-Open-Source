...
- 与通话状态紧关联，负责引导程序和业务小程序的生命周期管理，为小程序提供稳定的运行环境；  
- 小程序存储空间隔离，保证数据安全；  
- 对小程序包进行签名认证；
...
- 接入DCLab，为开发者提供完全对标现网接口能力的DC业务开发调试环境。
...
- 打包：目前共配置了四个渠道包：Normal(悬浮球入口版本)、Dialer(拨号盘入口版本)、Local(本地调试版本，用于本地调试)、Lab(接入了DCLab，用于调试及体验业务)
...
- 小程序本地调试：按照普通apk安装方式将Local版本SDK安装到手机，并将小程序zip包推至手机sdcard中，然后从手机桌面启动“电信增强通话”app，即可配置并调试小程序。  
- DCLab调测：联系我们在DCLab上部署小程序和AS，由DCLab分配体验号码，请按照普通apk安装方式将Lab版本SDK安装到手机，从手机桌面启动“电信增强通话”app，即可拨号体验。
...
1、从[开源网站](https://github.com/GSMATerminals/IMS-DC-SDK-Open-Source/releases/tag/release-26.2.0)上下载Local版本apk和小程序包并在手机上安装。
...
### 4、如何使用Lab版本SDK？
1、从[开源网站](https://github.com/GSMATerminals/IMS-DC-SDK-Open-Source/releases/tag/release-26.2.0)上下载Lab版本apk并在手机上安装，手机可上网。

2、联系我们获取体验号码的二维码。

3、在手机桌面找到"5G增强通话"APP并打开，扫描二维码。

4、拨打体验号码，使用DCLab上已有的DC业务。

5、也可联系我们在DCLab上部署DC小程序和业务AS，开展调测体验。
